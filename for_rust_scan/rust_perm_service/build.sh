...
cd $cur_dir
cargo clean
RUSTC_BOOTSTRAP=1 cargo build --features="$features" --target=aarch64-unknown-teeos --release

cp $cur_dir/target/aarch64-unknown-teeos/release/librust_perm_service.a $target_dir
